...
#define PAC_EXCEPT(code, desc)         \
	pac::ExceptionFactory::throwException(code, code, desc, __FUNCTION__, __FILE__, __LINE__)
#define PAC_EXCEPT_EX(code, num, desc) \
	pac::ExceptionFactory::throwException(code, num, desc, __FUNCTION__, __FILE__, __LINE__)
#else
