...
*/
  ...
  */
  ...
  This method can be used to make file path strings which point to the same
  directory
  ...
  */
  ...
  //-----------------------------------------------------------------------
  static std::string getDefaultStringLocale(void) {
    return msDefaultStringLocale;
  }
  //-----------------------------------------------------------------------
...
protected:
  ...
  /// Constant blank string, useful for returning by ref where local does not
  /// exist
